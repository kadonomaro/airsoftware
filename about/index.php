...
<body class="company-page">
        ...
        <div class="company-hero__content">
            <div class="company-hero__text">
                <div class="magic-scroll js-magic-scroll">
                    <p class="magic-scroll__item js-magic-scroll-item">
    ...
    <section class="company-map section">
        <header class="section__header">
            <h2 class="section__title section__title--dark">Адрес компании</h2>
            <span class="section__subtitle section__subtitle--dark">Вы можете найти нас по этому адресу, мы всегда рады посетителям</span>
        </header>
