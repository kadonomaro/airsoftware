...
<main class="policy section">
    <div class="container">
        <header class="section__header">
            <h1 class="section__title">Политика в отношении обработки персональных данных</h1>
        </header>
        <div class="policy__content">
            <div class="policy__text">
                ...
                <p>
                    ...
                    персональных данных и меры по обеспечению безопасности персональных данных Airsoftware (далее – Оператор).
                </p>
                <ol>
                    <li>
                    ...
                    <li>
                        ...
                        которую Оператор может получить о посетителях веб-сайта <a class="link link--light" href="http://airsoftware.ru.com/">http://airsoftware.ru.com/</a>.
                    </li>
                </ol>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        данных, обеспечивающих их доступность в сети интернет по сетевому
                        адресу <a class="link link--light" href="http://airsoftware.ru.com/">http://airsoftware.ru.com/</a>;
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        определяемому Пользователю веб-сайта <a class="link link--light" href="http://airsoftware.ru.com/">http://airsoftware.ru.com/</a>;
                    </li>
                    <li>
                        Пользователь – любой посетитель веб-сайта <a class="link link--light" href="http://airsoftware.ru.com/">http://airsoftware.ru.com/</a>;
                    </li>
                    <li>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        info@airsoftware.ru.com с пометкой «Отказ от уведомлениях о новых продуктах и услугах и специальных
                        предложениях».
                    </li>
                    <li>
                ...
                <ol>
                    <li>
                        ...
                        <a class="link link--light" href="http://airsoftware.ru.com/">http://airsoftware.ru.com/</a>.
                    ...
                    <li>
                        ...
                        в настройках браузера Пользователя (включено сохранение файлов «cookie» и использование технологии JavaScript).
                    </li>
                </ol>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <a class="link link--light" href="mailto:info@airsoftware.ru.com">info@airsoftware.ru.com</a> с пометкой «Актуализация персональных данных».
                    </li>
                    <li>
                        ...
                        посредством электронной почты на электронный адрес Оператора info@airsoftware.ru.com
                ...
                <ol>
                    <li>
                        ...
                        персональных данных, обратившись к Оператору с помощью электронной почты info@airsoftware.ru.com.
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <a class="link link--light" href="/policy">http://airsoftware.ru.com/policy</a>.
                    </li>
                </ol>
            </div>
        </div>
